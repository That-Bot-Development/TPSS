...
class BanDM(BaseModule):
    ...
    async def on_message(self, message:discord.Message):
        ...
        # DEPRECATION ALERT
            ...
            message.channel.send(EmbedMaker(embed_type=EmbedType.MISC,title="<:alert:1346654360012329044> Deprecated command!",message="The `.punishments` command is no longer updated with the most recent punishment logs and will soon be retired.\nPlease use `/punishments` instead!"))